...
[2026-04-25T00:54+09:00] [round 10] [deploying] Auto-capture motion gate — DeviceMotion EWMA (α=0.25, ~200ms 윈도우) > 0.4 m/s² 면 셔터 보류, '📷 카메라 안정 대기 중' 표시. R9 가 흔들리는 도중 발사하던 상황 방지 → motion blur 사진 발생률 ↓. R7 보다 앞단에서 차단
