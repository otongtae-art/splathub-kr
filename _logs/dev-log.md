...
[2026-04-25T02:54+09:00] [round 25] [deploying] VGGT/TRELLIS 결과 토글 — R19 폴백이 VGGT 결과를 덮어쓰던 것을 vggtBytes/trellisBytes 별도 보관으로 변경. 헤더에 [VGGT(실측)] [TRELLIS(AI)] 토글 추가, 사용자가 두 결과 비교 가능. monster banner 는 VGGT 모드에서만 표시
