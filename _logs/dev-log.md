...
[2026-04-25T02:46+09:00] [round 24] [deploying] TRELLIS 'AI 생성' 라벨 — R19 폴백이 활성화되어 viewer 가 photogrammetry 가 아닌 AI 결과를 보여줄 때, 헤더에 amber 'AI 생성' 배지 + 'TRELLIS.2 · 1장 기반 (실측 X)' 텍스트. 사용자가 결과 출처를 명확히 인지 → 신뢰성/진실성
