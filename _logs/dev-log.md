...
[2026-04-25T01:35+09:00] [round 15] [deploying] 환경 사전 체크 — 카메라 시작 후 1초간 brightness 5회 sample, 평균<60 시 'dim' banner ('💡 환경이 어둡습니다 (밝기 X) — 더 밝은 곳 권장'). 사용자가 20+ 사진 투자 전에 환경 개선 결정. shots>0 이면 skip (재실행 안 함), [무시] 버튼으로 dismiss
