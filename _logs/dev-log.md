...
[2026-04-25T03:18+09:00] [round 28] [deploying] 이전 세션 이어가기 — /capture 진입 시 IndexedDB 에서 최근 24시간 내 세션 자동 감지, 카메라 시작 전 화면에 '📂 이전 세션 발견 · N장 / X분 전 촬영. 이어가기' 배너 표시. 브라우저 닫고 돌아온 사용자가 처음부터 다시 안 찍어도 됨
