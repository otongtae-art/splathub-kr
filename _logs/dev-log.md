...
[2026-04-25T03:58+09:00] [round 33] [deploying] Mobile viewer stats — 기존 'hidden sm:inline' 으로 mobile 에서 안 보이던 viewer 통계 (pts/평탄도) 를 mobile 에서도 약식 표시 (예: '12k·28%'). desktop 은 풀 라벨 유지. tooltip 으로 해석 안내. 모바일 사용자 (capture 주 채널) 가 결과 품질 즉시 인지
