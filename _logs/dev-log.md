...
[2026-04-25T00:28+09:00] [round 7] [deploying] Sharpness 필터 — Laplacian variance (lib/sharpness.ts) 로 각 shot 선명도 측정, median*0.4 미만+abs<30 이면 흐림 판정. 썸네일 빨간 테두리+'흐림' 배지, VGGT 호출 전 자동 제외 (한도 30%), train 페이지에 '흐림 N장 자동 제외' 표시. 입력 노이즈 제거 → VGGT 포즈 추정 안정화
