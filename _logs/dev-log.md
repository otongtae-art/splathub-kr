...
[2026-04-25T04:14+09:00] [round 35] [deploying] ErrorBoundary for MeshViewer — components/ErrorBoundary.tsx generic class component, train 페이지 viewer 감싸 Three.js/WebGL 크래시 시 white-screen 방지. fallback UI 에 [.glb 다운로드만] [새로고침] 옵션 — 사용자가 결과 잃지 않게
