...
[2026-04-25T02:14+09:00] [round 20] [deploying] Sharpness 메타 → train 전달 — capture 가 sharpnessScores[] 를 IndexedDB CaptureMeta 에 저장. R19 TRELLIS 폴백이 가장 sharp 한 shot 자동 선택 (이전엔 첫 사진 무조건). best photo 1장 → 더 좋은 AI 생성 결과
