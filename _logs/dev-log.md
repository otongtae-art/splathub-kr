...
[2026-04-25T04:06+09:00] [round 34] [deploying] 자동 학습 이동 옵션 — 토글 ON 시 30장 (TARGET_SHOTS) 도달하면 5초 countdown banner + 취소 버튼 → 자동 proceedToTraining(). R9 auto-capture 와 결합 시 사용자가 폰 들고 걷기만 하면 학습 페이지까지 hands-free 도달
