...
[2026-04-25T00:18+09:00] [round 6] [deploying] 미니맵 enhancement — 36섹터 ring (covered=초록, missing=빨강 dim) + 'you are here' live alpha 화살표 (5Hz 폴링). 사용자가 어느 방향이 빈지 즉시 인지 → 무작위 회전 대신 빈 섹터로 이동 → photo 분포 균등화 → monster 발생률 ↓
