...
[2026-04-25T02:06+09:00] [round 19] [deploying] TRELLIS.2 monster 폴백 — VGGT 결과가 monster (R5 휴리스틱) 일 때 banner 에 '🪄 TRELLIS.2 (1장 AI)' 버튼 추가. 클릭 시 첫 사진을 generative AI 로 변환 → 세션 구제 (사용자가 60초 VGGT 낭비 후 빈 손으로 가는 대신 무언가 받음)
