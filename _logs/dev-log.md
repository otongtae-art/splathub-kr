...
[2026-04-25T01:10+09:00] [round 12] [deploying] Multi-shot burst (auto-capture 만) — 빈 섹터 진입 시 3프레임 70ms 간격 캡처, sharpness 가장 높은 프레임 채택. Apple Object Capture 패턴. 250ms 추가 지연이지만 사용자가 셔터 안 누르므로 인지 X. Manual shutter 는 단일 (현재 응답성 유지). 흐림 사진 발생률 대폭 감소
