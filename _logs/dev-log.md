...
[2026-04-25T01:43+09:00] [round 16] [deploying] 환경 사전 체크에 feature density 추가 — detectFeatures 5회 sample, 평균<20 면 'low_texture' issue. dim/low_texture/둘 다 분기 메시지 ('🎨 질감 부족 — 단색 벽 photogrammetry 작동 불가'). textureless 는 photogrammetry 의 본질적 실패 모드
