...
[2026-04-25T01:26+09:00] [round 14] [deploying] 햅틱 피드백 + manual 셔터 burst 토글 — lib/haptics.ts (shutterHaptic 30ms / warningHaptic 더블 탭). 모든 captureShot 에 진동, 흐림/어두움 toast 시 더블탭. Manual 셔터에 '✨ 3장 burst' 토글 (auto 와 별개). Android Chrome 만 실제 동작, 그 외 silent
